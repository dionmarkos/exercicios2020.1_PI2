...
print('Tamanho range: ', sys.getsizeof(range(9999)))
...
metodosList = str(dir(list)).split(", ")
metodosTupla = str(dir(tuple)).split(", ")
metodosIguais = []

for i in metodosList:
    for j in metodosTupla:
        if i in j:
            metodosIguais.append(i)
